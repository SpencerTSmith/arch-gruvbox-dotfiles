...
messages=(
  ...
  "THE CONTEST ENDURES IN ALL ETERNITY"
  "EVERYTHING THAT HAPPENS, HAPPENS IN ACCORDANCE WITH THIS STRIFE"
  "IT IS THE CONTEST-IDEA OF THE GREEK INDIVIDUAL AND THE GREEK STATE"
  "SO THE QUALITIES WRESTLE WITH ONE ANOTHER"
  "THE EVERLASTING AND EXCLUSIVE COMING-TO-BE"
  "EVERLASTINGLY, A GIVEN QUALITY CONTENDS AGAINST ITSELF"
  "ATTACHED TO EACH OTHER AND INTERLOCKED AT ANY GIVEN MOMENT LIKE WRESTLERS"
  "OF WHOM SOMETIMES THE ONE, SOMETIMES THE OTHER IS ON TOP"
  "I, THE LAST DISCIPLE OF THE PHILOSOPHER DIONYSUS"
  "I, THE PROPHET OF ETERNAL RECURRENCE"
